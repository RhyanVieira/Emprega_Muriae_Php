						...
						<div class="col-lg-8">
							<div class="job-info-box">
								...
								<div class="vaga-actions m-t20">
									...
									<?php elseif ($userTipo === 'EMPRESA'): ?>
										<!-- Para empresa -->
										<a href="<?= baseUrl() ?>vagaMensagem/listarEmpresa/<?= $dados['vaga']['vaga_id'] ?>" class="site-button m-r10"><i class="fa fa-comments"></i> Mensagens dos candidatos</a>
									<?php else: ?>
