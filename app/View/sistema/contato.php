    ...
    <div class="page-content bg-white">
		<!-- inner page banner -->
        <div class="dez-bnr-inr overlay-black-middle" style="background-image:url(/assets/img/banner/Banner_Contato.jpg);">
            <div class="container">
                <div class="dez-bnr-inr-entry">
					...
					<div class="breadcrumb-row">
						<ul class="list-inline">
							<li>Estamos aqui para tirar dúvidas, receber sugestões ou ajudar no que for preciso.</li>
						</ul>
					</div>
					<!-- Breadcrumb row END -->
                </div>
                ...
                <div class="row">
					...
					<div class="col-lg-4 col-md-6 d-lg-flex d-md-flex">
                        <div class="p-a30 border m-b30 contact-area border-1 align-self-stretch radius-sm">
							...
							<p>Se você tiver qualquer dúvida, entre em contato conosco pelos meios abaixo.</p>
                            <ul class="no-margin">
                                <li class="icon-bx-wraper left m-b30">
                                    <div class="icon-bx-xs border-1"> <a href="#" class="icon-cell"><i class="ti-location-pin"></i></a> </div>
                                    <div class="icon-content">
                                        <h6 class="text-uppercase m-tb0 dez-tilte">Endereço:</h6>
                                        <p>Av. Constantino Pinto 236, Muriaé, MG, 36880-000</p>
                                    </div>
                                </li>
                                <li class="icon-bx-wraper left  m-b30">
                                    ...
                                    <div class="col-lg-12">
                                        <div class="form-group">
                                            <div class="input-group">
                                                <input name="dzName" type="text" required class="form-control" placeholder="Seu nome">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-lg-12">
                                        <div class="form-group">
                                            <div class="input-group"> 
											<input name="dzEmail" type="email" class="form-control" required  placeholder="E-mail" >
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-lg-12">
					...
					<div class="col-lg-4 col-md-12 d-lg-flex m-b30">
						<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d1648.1599689434986!2d-42.3694882569071!3d-21.128231058926822!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0xbcc642ba70c89b%3A0xab066ffe3c48d7f0!2sPrefeitura%20Municipal%20de%20Muria%C3%A9!5e1!3m2!1spt-BR!2sbr!4v1748800033842!5m2!1spt-BR!2sbr" class="align-self-stretch radius-sm" style="border:0; width:100%; min-height:350px;" allowfullscreen></iframe>
                    </div>
                </div>
            </div>
        </div>
