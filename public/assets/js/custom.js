	...
	var dzTheme = function(){
		...
		if(screenWidth < 991)
		{
			if($('.mo-left .header-nav').children('div').length == 0){
				...
				jQuery('.mo-left .header-nav .logo-header > a > img').attr('src','images/logo/logo_navbar.png');
				jQuery('.mo-left.lw .header-nav .logo-header > a > img').attr('src','images/logo/logo_footer.jpg');
			}
		}else{
	...
	var headerFix = function(){
		...
		jQuery(window).on('scroll', function () {
			...
			if ($(window).scrollTop() > menu.offset().top) {
				...
				$('.header-style-5 .container > .logo-header .logo').attr('src','images/logo/logo_navbar.png');
			} else {
				menu.removeClass('is-fixed');
				$('.header-style-5 .container > .logo-header .logo').attr('src','images/logo/logo_footer.jpg')
			}
		});
