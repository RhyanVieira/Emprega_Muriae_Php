...
-- Copiando dados para a tabela emprega_muriae.categoria_estabelecimento: ~81 rows (aproximadamente)
...
CREATE TABLE IF NOT EXISTS `vaga` (
  ...
  `beneficios` text CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
  ...
  `vinculo` int NOT NULL COMMENT '1 - CLT, 2 - PJ,   3 - Estágio, 4 - Temporário, 5 - Autônomo, 6 - Freelancer''',
...
CREATE TABLE IF NOT EXISTS `vaga_mensagem` (
  ...
  `vaga_id` int NOT NULL,
  `curriculum_id` int NOT NULL,
  `remetente_tipo` enum('PF','EMPRESA') NOT NULL,
